...
public class XMPPClient {
	...
	public void connect(String userName, String password, String serviceName, String host, int port) {
		...
		connection.setPacketReplyTimeout(10000); // TODO read from properties
													// file.
	...
	public void findInitialPresences() {
		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				// LdapUtils.getInstance().getUidMap(LdapConnectionListener.getConnection(),
				...
				// eventBroker.send(LiderConstants.EventTopics.ROSTER_ONLINE,
				// dn);
				// } else if (presence.getType() == Type.unavailable) {
				// // TODO system-wide log msg
				// eventBroker.send(LiderConstants.EventTopics.ROSTER_OFFLINE,
				// dn);
				// }
				// }
				// }
